...
$_thAvatar   = $userAvatar ?? '/jobhub/assets/upload/profile.png';
...
<header class="top-header px-6 py-4" style="display:flex; align-items:center; justify-content:space-between;">
    <div style="display:flex; align-items:center; gap:16px;">
        <button onclick="toggleSidebar()" class="lg:hidden header-icon-btn">
            <i data-lucide="menu" style="font-size:18px;"></i>
        </button>
        <div>
    ...
    <div style="display:flex; align-items:center; gap:8px;">
        ...
        <div style="position:relative; display:flex; align-items:center;" class="hidden sm:flex">
            <i data-lucide="search" style="position:absolute; left:14px; color:#94a3b8; font-size:13px; pointer-events:none;"></i>
        ...
        <a href="../shared/notifications_page.php" class="header-icon-btn" title="Notifications" style="position:relative;">
            <i data-lucide="bell" style="font-size:16px;"></i>
            <?php if ($_thUnread > 0): ?>
        ...
        <div style="position:relative;" class="quick-actions-dropdown">
            <button onclick="toggleQuickActions()" class="header-icon-btn" title="Quick Actions">
                <i data-lucide="plus" style="font-size:16px;"></i>
            </button>
            <div id="quickActionsMenu" style="display:none; position:absolute; right:0; top:calc(100% + 8px); background:#fff; border:1px solid #E5EDF6; border-radius:16px; box-shadow:0 12px 35px rgba(15,23,42,0.12); min-width:200px; padding:8px; z-index:50;">
                ...
                <?php if ($_thRole === 'Admin'): ?>
                    <a href="/jobhub/admin/users.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="users" style="width:16px; color:#2563EB;"></i> Manage Users
                    </a>
                    <a href="/jobhub/admin/jobs.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="briefcase" style="width:16px; color:#059669;"></i> Manage Jobs
                    </a>
                    <a href="/jobhub/admin/settings.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="settings" style="width:16px; color:#7C3AED;"></i> Platform Settings
                    </a>
                <?php elseif ($_thRole === 'Client'): ?>
                    <a href="/jobhub/client/post_job.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="circle-check" style="width:16px; color:#2563EB;"></i> Post a Job
                    </a>
                    <a href="/jobhub/client/recommended_freelancers.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="user-plus" style="width:16px; color:#059669;"></i> Find Freelancers
                    </a>
                    <a href="/jobhub/client/contracts.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="handshake" style="width:16px; color:#7C3AED;"></i> View Contracts
                    </a>
                <?php else: ?>
                    <a href="/jobhub/freelancer/browse_jobs.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="search" style="width:16px; color:#2563EB;"></i> Browse Jobs
                    </a>
                    <a href="/jobhub/freelancer/proposals.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="file-text" style="width:16px; color:#059669;"></i> My Proposals
                    </a>
                    <a href="/jobhub/freelancer/earnings.php" style="display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; font-size:13px; color:#475569; text-decoration:none; transition:background 0.15s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        <i data-lucide="wallet" style="width:16px; color:#7C3AED;"></i> Withdraw Earnings
                    </a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <button onclick="toggleDarkMode()" class="header-icon-btn" title="Toggle dark mode">
            <i data-lucide="moon" style="font-size:15px;" id="darkModeIcon"></i>
        </button>
...
function handleGlobalSearch(query) {
    ...
    // Render results
    if (unique.length === 0) {
        resultsDiv.innerHTML = '<div style="padding:20px; text-align:center; color:#94a3b8; font-size:13px;"><i data-lucide="search" style="font-size:20px; display:block; margin-bottom:8px; color:#cbd5e1;"></i>No results found for "' + escapeHtml(query) + '"</div>';
    } else {

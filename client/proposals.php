    ...
    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm fade-in">
        <form method="GET" class="flex flex-col sm:flex-row gap-3">
            <div class="relative flex-1">
                ...
                <select name="job" class="appearance-none w-full bg-gray-50 border border-gray-200 rounded-xl pl-11 pr-10 py-2.5 text-sm text-gray-700 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all cursor-pointer">
            ...
            <div class="relative">
                ...
                <select name="sort" class="appearance-none bg-gray-50 border border-gray-200 rounded-xl pl-11 pr-10 py-2.5 text-sm text-gray-700 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all cursor-pointer">
            ...
            <?php if ($jobFilter > 0 || $statusFilter !== 'all' || $sort !== 'newest'): ?>
                <a href="proposals.php" class="px-4 py-2.5 border border-gray-200 text-gray-600 hover:text-gray-900 hover:border-gray-300 rounded-xl text-sm font-medium transition-all flex items-center gap-2 justify-center">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500 mb-1">
                                    Re: <a href="job_detail.php?id=<?= (int) $p['job_id'] ?>" class="font-medium text-gray-700 hover:text-blue-600 transition-colors"><?= sanitize_string($p['job_title']) ?></a>
                                </p>
                                ...
                                <div class="flex flex-wrap items-center gap-4 text-xs text-gray-400 mb-3">
                                    <span class="flex items-center gap-1.5">
                                        ...
                                        Bid: <span class="font-semibold text-gray-700"><?= format_currency((float) $p['amount']) ?></span>
                                    </span>
                                    <span class="flex items-center gap-1.5">
                                ...
                                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                    <p class="text-sm text-gray-600 leading-relaxed whitespace-pre-line line-clamp-2"><?= sanitize_string($p['proposal_text']) ?></p>
                                </div>
                            </div>

...
<div><h2 class="text-base font-bold text-gray-900">Payment History</h2><p class="text-xs text-gray-400"><?= $totalPayments ?> payment<?= $totalPayments !== 1 ? 's' : '' ?> recorded</p></div>
</div>

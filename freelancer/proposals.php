...
$allowedStatuses = ['all', 'pending', 'accepted', 'rejected', 'withdrawn'];
            ...
            <div class="mb-4">
                <div class="flex flex-wrap gap-2">
                    ...
                    $filters = [
                        ...
                        'rejected' => ['Rejected', 'circle-x'],
                        'withdrawn' => ['Withdrawn', 'ban'],
                    ];
                    $filterStyles = [
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-start gap-4">
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2 mb-2">
                                    <a href="proposal_detail.php?id=<?= (int) $p['id'] ?>" class="text-base font-bold text-gray-900 hover:text-indigo-600 transition-colors">
                                ...
                                <div class="flex flex-wrap items-center gap-4 text-xs text-gray-400 mb-3">
                                    ...
                                    <span class="flex items-center gap-1.5">
                                        <i data-lucide="tag" class="text-indigo-400"></i>
                                    ...
                                    <span class="flex items-center gap-1.5">
                                        <i data-lucide="calendar" class="text-gray-400"></i>
                            ...
                            <div class="flex flex-wrap lg:flex-nowrap items-center gap-2 lg:flex-col lg:items-stretch lg:min-w-[140px]">
                                <a href="proposal_detail.php?id=<?= (int) $p['id'] ?>"
                                   class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-600 text-xs font-semibold rounded-xl transition-all">
                                    <i data-lucide="eye" class="text-[10px]"></i> View Details
                                </a>
                                <?php if ($p['status'] === 'pending'): ?>
                                <a href="edit_proposal.php?id=<?= (int) $p['id'] ?>"
                                   class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 text-xs font-semibold rounded-xl transition-all">
                                    <i data-lucide="pencil" class="text-[10px]"></i> Edit
                                </a>
                                <form method="POST" action="withdraw_proposal.php" onsubmit="return confirm('Are you sure you want to withdraw this proposal? This action cannot be undone.');">
                                    <?= csrf_field() ?>
                                    <input type="hidden" name="proposal_id" value="<?= (int) $p['id'] ?>">
                                    <button type="submit"
                                       class="inline-flex items-center gap-2 px-4 py-2 bg-red-50 hover:bg-red-100 text-red-500 text-xs font-semibold rounded-xl transition-all w-full">
                                        <i data-lucide="undo" class="text-[10px]"></i> Withdraw
                                    </button>
                                </form>
                                <?php endif; ?>
                                ...
                                <a href="contracts.php"
                                   class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-600 text-xs font-semibold rounded-xl transition-all">
                                    <i data-lucide="handshake" class="text-[10px]"></i> View Contract
                                </a>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm fade-in">
                <div class="text-center py-16 px-6">
                    <div class="w-24 h-24 rounded-3xl bg-gradient-to-br from-violet-50 to-purple-50 flex items-center justify-center mx-auto mb-6 border border-violet-100">
                        <i data-lucide="file-text" class="text-4xl text-violet-300"></i>
                    </div>
